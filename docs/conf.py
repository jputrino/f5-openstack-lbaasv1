...
.. attention::
   ...
   **End of Technical Support for F5 OpenStack LBaaS version 1**
   ...
   F5 announces the End of Technical Support (EoTS) for the F5 OpenStack LBaaS version 1 integration.
...
# have a caption. For now, it works only with the HTML builder. Default is
# False.
numfig = "True"
...
html_title = "F5 OpenStack LBaaSv1"
...
htmlhelp_basename = 'F5OpenStackLBaaSv1doc'
...
latex_documents = [
    (master_doc, 'F5OpenStackLBaaSv1.tex', u'F5 OpenStack LBaaSv1 Documentation',
...
man_pages = [
    (master_doc, 'f5openstacklbaasv1', u'F5 OpenStack LBaaSv1 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5OpenStackLBaaSv1', u'F5 OpenStack LBaaSv1 Documentation',
     author, 'F5OpenStackLBaaSv1', 'One line description of project.',
     'Miscellaneous'),
]
...
#     'docs': (
#     'http://f5-openstack-docs.readthedocs.org/en/latest', None),
#     'lbaasv2': (
#     'http://f5-openstack-lbaasv2-driver.readthedocs.org/en/latest', None),
#     }
